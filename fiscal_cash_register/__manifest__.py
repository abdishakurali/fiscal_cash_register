...
* Cash-in/Cash-out operation management.
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'fiscal_cash_register/static/src/js/closingPopup.js',
            'fiscal_cash_register/static/src/js/payment_screen.js',
            'fiscal_cash_register/static/src/js/pos_franchise_tech_title.js',
            'fiscal_cash_register/static/src/xml/navbar_logo.xml',
            'fiscal_cash_register/static/src/xml/pos.xml',
            'fiscal_cash_register/static/src/xml/closing_tab.xml',
        ],
    },
    'installable': True,
    'auto_install': False,
